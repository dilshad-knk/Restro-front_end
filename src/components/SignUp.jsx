...
function SignUp() {
    ...
    const handleSubmit = async(event) => {
      ...
      try {
        ...
        let res = await instance.post('/users/register', {
  ...
  return (
    <Container>
        ...
        <Row>
            <Col>
                    <h3 className='my-4 text-dark fs-1 mb-5'>SignUp :</h3>
            </Col>
        </Row>
        <Row>
              ...
              <Form noValidate  validated={validated}  onSubmit={handleSubmit} >
                    ...
                    <Form.Group className="mb-4" controlId="formGroupPassword">
                        ...
                        <Form.Control
                          ...
                          required
                        />
                        {passwordError && <div className='text-danger p-1' >{passwordError}</div>}
